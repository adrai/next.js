  ...
  return (
    <main>
      ...
      <ul>
        ...
        <li>
          <DebugLinks href="/shells/with-root-param/en/valid-root-param" />
        </li>
        <li>
          <DebugLinks href="/shells/with-root-param/en/invalid-root-param-page" />
        </li>
        <li>
          <DebugLinks href="/shells/with-root-param/en/invalid-root-param-cache" />
        </li>
      </ul>
    </main>
  )
