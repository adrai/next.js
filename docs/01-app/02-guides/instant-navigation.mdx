...
<Image
  alt="Navigation Inspector panel shown in three states: idle with a Start Capturing button, awaiting a navigation while capturing, and the prefetched UI frozen for the last navigation"
  srcLight="/docs/light/inspector-states-cropped.png"
  srcDark="/docs/dark/inspector-states-cropped.png"
  width="3258"
  height="1020"
/>
...
<Image
  alt="Next.js dev overlay surfacing an Insights entry titled 'Next.js encountered runtime data during a navigation' for app/shop/[slug]/page.tsx, with the await cookies() call highlighted and three suggested fixes: Stream, Cache, and Block"
  srcLight="/docs/light/instant-runtime-data-insight-cropped.png"
  srcDark="/docs/dark/instant-runtime-data-insight-cropped.png"
  width="2420"
  height="1664"
/>
